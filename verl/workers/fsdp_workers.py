...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(self,
        ...
        stop_token = "<Dafny>"
        stop_token_id = self.tokenizer.encode(stop_token)
        # print("##################")
        # print(stop_token_id)
    ...
    @register(dispatch_mode=Dispatch.DP_COMPUTE_PROTO)
    def generate_sequences(self, prompts: DataProto, eos_token_id=None):
        # Support all hardwares
        ...
        stop_tokens = ["</Dafny>", "</Answer>", "<|im_end|>", "<|endoftext|>"]
        stop_token = "<|im_end|>"
        meta_info['stop_token'] = [self.tokenizer.encode(stop_token) for stop_token in stop_tokens]
        meta_info['eos_token_id'] = self.tokenizer.encode(stop_token)
