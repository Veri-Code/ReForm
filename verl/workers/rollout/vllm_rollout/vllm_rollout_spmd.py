...
class vLLMRollout(BaseRollout):
    ...
    def __init__(self, model_path: str, config: DictConfig, tokenizer, model_hf_config, **kwargs):
        ...
        #     actor_module.resize_token_embeddings(len(tokenizer))
        # print("####################")
        # print(len(tokenizer))
        ...
        # self.stop_tokens = [self.tokenizer.encode(stop_token) for stop_token in stop_tokens]
        # print("&&&&&&&&&&&&")
        # print(self.stop_tokens)

    @contextmanager
    def update_sampling_params(self, **kwargs):
        # update sampling params
        old_sampling_params_args = {}
        # setattr(self.sampling_params, stop_token_ids, self.stop_tokens)
        if kwargs:
