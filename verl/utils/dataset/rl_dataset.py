...
class RLHFDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        if self.filter_overlong_prompts:
            ...
            self.dataframe = self.dataframe.filter(
                lambda doc: len(tokenizer.apply_chat_template(doc[prompt_key], add_generation_prompt=False)
    ...
    def __getitem__(self, item):
        ...
        row_dict['data_string'] = prompt_with_chat_template
        ...
        row_dict["index"] = index + 100000 * int(self.is_train)
