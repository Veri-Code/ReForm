...
"""
RUNNING_LOG = "/nas/shared/sys2/chefengdi/eval_log/fengdi/eval_plot_6/"
...
if __name__ == "__main__":
    ...
    folder_names = [
        "/nas/shared/sys2/chefengdi/report_shots/Report_0715_naive_reward_3B/global_step_80",
        "/nas/shared/sys2/chefengdi/report_shots/Report_0715_naive_reward_3B/global_step_160"
    ]
    # folder_names = [
    ...
    BoN = 128
    max_step_num =0 
    local_dir ="/nas/shared/sys2/chefengdi/eval_log/Jul_report_results/report_shots/final_scores/naive_2"
    import datetime
    ...
    for folder_name in folder_names:
        ...
        for step_key in total_scores.keys():
            for shot_key in total_scores[step_key].keys():
                for score_list in total_scores[step_key][shot_key]:
                    if len(score_list) > 8 and score_list[2] == -1:
                        pos3_count += 1
        ...
        for step_key in total_scores:
            for shot_key in total_scores[step_key]:
                for score_list in total_scores[step_key][shot_key]:
                    if len(score_list) > 3 and score_list[2] == -1:
                        score_list[8] = 0
                    # if len(score_list) > 13 and score_list[13] == -1:
                    #     score_list[13] = 0
