...
"""
RUNNING_LOG = "/nas/shared/sys2/chefengdi/eval_log/fengdi/eval_plot_5/"
...
if __name__ == "__main__":
    ...
    cumulative_scores = {}
    folder_names = [
        "/nas/shared/sys2/chefengdi/report_shots/3B_BoN4_entropy/global_step_80",
        "/nas/shared/sys2/chefengdi/report_shots/3B_BoN4_entropy/global_step_160"
     ]
    """
    Three dir to change:
    RUNNING_LOG: store the execution dafny files and delete them after evaluation
    ...
    BoN = 128
    max_step_num =0 
    local_dir = "/nas/shared/sys2/chefengdi/eval_log/Jul_report_results/report_shots/final_scores/entropy_2"
    import datetime
