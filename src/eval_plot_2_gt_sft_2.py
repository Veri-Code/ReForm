...
# def process_sft(index):
#     sft_path = "/nas/shared/sys2/chefengdi/eval_log/3B_sft_128/sft_ckpt/saves"
#     sft_file = os.path.join(sft_path, str(index))
def process_single_index(folder_name, index, BoN=1):
    ...
    for idx, file in enumerate(sorted_filelists):
        ...
        scores[idx//BoN][idx%BoN]= compute_subset_score(
            ...
            exp_name = 'test_score',
            index=index,
            output_dir="/cpfs04/user/huangxuhan_p/case_study/novel_statements_with_entropy_0714/eval_plot/",
            eval_plot=True)

        # # # delete all files in the folder
    if scores[idx//BoN][idx%BoN][8] != 1:
        delete_dir = os.path.join("/cpfs04/user/huangxuhan_p/case_study/novel_statements_with_entropy_0714/eval_plot/", str(index))
        ...
        save_dir = os.path.join("/cpfs04/user/huangxuhan_p/case_study/novel_statements_with_entropy_0714/eval_plot/success/", str(index))
...
if __name__ == "__main__":
    ...
    # /nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_entropy0.02_with_kl

    # sft_path /nas/shared/sys2/liyizhi/folder-0630/sft_all_merge_128
    folder_names = [
        # "/nas/shared/sys2/chefengdi/eval_log/3B_sft_128/sft_ckpt/saves",
        # "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_entropy0.02_with_kl/global_step_20",
        ...
        # "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_entropy0.02_with_kl/global_step_80",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_3B/3B_prevent_hacking_rollout_4/global_step_20",
        ...
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_3B/3B_prevent_hacking_rollout_4/global_step_160",
