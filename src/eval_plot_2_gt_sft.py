...
def process_single_index(folder_name, index, BoN=1):
    ...
    for idx, file in enumerate(sorted_filelists):
        ...
        scores[idx//BoN][idx%BoN]= compute_subset_score(
            ...
            exp_name = 'test_score',
            index=index,
            output_dir="/cpfs04/user/huangxuhan_p/case_study/novel_statements_new_new/eval_plot/",
            eval_plot=True)

        # # # delete all files in the folder
    if scores[idx//BoN][idx%BoN][8] != 1:
        delete_dir = os.path.join("/cpfs04/user/huangxuhan_p/case_study/novel_statements_new_new/eval_plot/", str(index))
        ...
        save_dir = os.path.join("/cpfs04/user/huangxuhan_p/case_study/novel_statements_new_new/eval_plot/success/", str(index))
...
if __name__ == "__main__":
    ...
    BoN = 128
    max_step_num =0 
    local_dir = "/cpfs04/user/huangxuhan_p/case_study/novel_statements_new_new"
    import datetime
