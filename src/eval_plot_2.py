...
"""
RUNNING_LOG = "/nas/shared/sys2/chefengdi/eval_log/fengdi/eval_plot/"
...
if __name__ == "__main__":
    ...
    folder_names = [
        "/nas/shared/sys2/chefengdi/report_shots/entropy_only_1/3B_BoN4_entropy_only/global_step_20",
        "/nas/shared/sys2/chefengdi/report_shots/entropy_only_1/3B_BoN4_entropy_only/global_step_40",
    ]
    ...
    BoN = 128
    max_step_num =0 
    local_dir = "/nas/shared/sys2/chefengdi/eval_log/Jul_report_results/report_shots/final_scores/entropy_only_1"
    import datetime
