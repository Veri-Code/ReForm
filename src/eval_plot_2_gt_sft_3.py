...
"""
Three dir to change:
RUNNING_LOG: store the execution dafny files and delete them after evaluation
log_dir: store the final score
folder_names: put the files or logs you want to evaluate
BoN: 1 for full log; 128 for shots
"""
RUNNING_LOG = "/cpfs04/user/huangxuhan_p/case_study/novel_statements_with_entropy_0714/eval_plot/"
...
def process_single_index(folder_name, index, BoN=1):
    ...
    for idx, file in enumerate(sorted_filelists):
        ...
        scores[idx//BoN][idx%BoN]= compute_subset_score(
            ...
            exp_name = 'test_score',
            index=index,
            output_dir=RUNNING_LOG,
            eval_plot=True)

        # # # delete all files in the folder
    # if scores[idx//BoN][idx%BoN][8] != 1:
        if scores[idx//BoN][idx%BoN][8] == 1:
            success_q_id = idx//BoN
            success_q_shot = idx%BoN+1
            save_information = {"success_q_id": success_q_id, "success_q_shot": success_q_shot, "filename": file, "success_index": index}
            if not os.path.exists(os.path.join(RUNNING_LOG, "success")):
                os.makedirs(os.path.join(RUNNING_LOG, "success"))
            json_save_path = f"{RUNNING_LOG}/success/q{idx//BoN}_shot{idx%BoN+1}.json"
            with open(json_save_path, 'w') as f:
                json.dump(save_information, f, indent=2)

        
    delete_dir = os.path.join(RUNNING_LOG, str(index))
        ...
        for step in range(step_num):
            for shot in range(shot_num):
                ...
                for result in total_scores:
                    if shot in result[step]:
                        final_scores[step*2+2][shot+1].append(result[step][shot])
                    else:
                        final_scores[step*2+2][shot+1].append([0,]*9)
                        print("Folder name: ", folder_name)
                        print("Shots end at", shot)
    return final_scores
...
if __name__ == "__main__":
    ...
    # folder_names = [
    #     "/nas/shared/sys2/chefengdi/dafny_full_log/3B_no_entropy/3B_naive_prevent_hacking_rollout_32",
    #     "/nas/shared/sys2/chefengdi/dafny_full_log/3B_no_entropy/3B_prevent_hacking_rollout_128",
    #     "/nas/shared/sys2/chefengdi/dafny_full_log/3B_no_entropy/3B_prevent_hacking_rollout_32",
    #     "/nas/shared/sys2/chefengdi/dafny_full_log/3B_no_entropy/3B_prevent_hacking_rollout_16",
    #     "/nas/shared/sys2/chefengdi/dafny_full_log/3B_no_entropy/3B_prevent_hacking_rollout_4",
    #     "/nas/shared/sys2/chefengdi/eval_log/3B_8_shots/sft_ckpt/saves",
    # ]
    ...
    folder_names = [
        # "/nas/shared/sys2/chefengdi/eval_log/3B_sft_128/sft_ckpt/saves",
        # "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_no_entropy_with_kl/global_step_20",
        # "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_no_entropy_with_kl/global_step_40",
        # "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_no_entropy_with_kl/global_step_60",
        # "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_no_entropy_with_kl/global_step_80",
        "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_entropy0.02_with_kl/global_step_40",
        # "/nas/shared/sys2/liyizhi/folder-0630/eval_log/DLC_naive_128/Subsetreward_entropy_3B_BoN4_entropy0.02_with_kl/global_step_60",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_3B/3B_prevent_hacking_rollout_4/global_step_40",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_3B/3B_prevent_hacking_rollout_4/global_step_80",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_xuhan_newest/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.1_clip_mean_1_kw_v3_0entropy_0.01kl_xh1/global_step_20",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_xuhan_newest/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.1_clip_mean_1_kw_v3_0entropy_0.01kl_xh1/global_step_40",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_xuhan_newest/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.1_clip_mean_1_kw_v3_0entropy_0.01kl_xh1/global_step_80",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_xuhan_newest/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.1_clip_mean_1_kw_v3_0entropy_0.01kl_xh1/global_step_160",
        # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_xuhan_newest/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.1_clip_mean_1_kw_v3_0entropy_0.01kl_xh1/global_step_320",
    ]
    # folder_names = [
    #     "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.1_clip_mean_1_kw_v3_0.02entropy_0.01kl_xh1/global_step_20",
    #     # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.1_clip_mean_1_kw_v3_0entropy_0.01kl_xh1/global_step_20",
    #     # "/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity/DLC-diversity_reward_qwen_3b_5k_sft_5k_rl_4rollout_0_1scale_5000_ref_0.085_clip_mean_1_kw_sim_v4_0.02entropy_0.01kl_xh2/global_step_40",
    # ]
    """
    IF running training result: change BoN to 1 and change exp_name to the basename of the folder_name
    """
    ...
    BoN = 128
    max_step_num =0 
    local_dir = "/cpfs04/user/huangxuhan_p/case_study/novel_statements_with_entropy_0714"
    import datetime
    ...
    def bench():
        ...
        local_dir = "/nas/shared/sys2/chefengdi/eval_log/3B_log_compare/round_5"
        ...
        shots_output_dir = os.path.join('/nas/shared/sys2/chefengdi/eval_log/3B_log_compare/round_5', "shots_comparison/")
