...
project_name='FinalTest_2'
exp_name='fengdi_grpo_5ksft_7B_naive_BoN8_prevent_hacking_v3_0625_11am'
...
# Training Config
MODEL_PATH="/nas/shared/sys2/liyizhi/Qwen2.5-Coder-7B_5k_sft_opt" # Adjust if you want to use the 7B model or another
...
##################################################################################################################
    ...
    ray job submit --address="http://127.0.0.1:8266" \
        ...
        python3 -m verl.trainer.main_ppo \
            ...
            reward_model.reward_type='naive' \
