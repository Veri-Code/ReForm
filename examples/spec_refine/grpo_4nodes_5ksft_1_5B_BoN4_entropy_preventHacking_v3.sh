...
# Training Config
MODEL_PATH="/nas/shared/sys2/liyizhi/LLaMA-Factory/saves/Qwen2.5-Coder-1.5B_5k_sft_opt" # Adjust if you want to use the 7B model or another
