...
ckpt_dir=("/oss/public/user/chefengdi/ckpts/" "/oss/public/user/yanch/")
exp_names=("3B_prevent_hacking_rollout_4" "DLC_4nodes_3B_reward_naive_0513_v5")
...
for ((i=0; i<TOTAL_TASKS; i++)); do
    ...
    if [ $((i % WORLD_SIZE)) -eq $RANK ]; then
        ...
        # 创建每个模型独立的输出目录
        OUTPUT_DIR="/nas/shared/sys2/chefengdi/eval_log/DLC_subset_diversity_3B_DafnyBench"
        mkdir -p $OUTPUT_DIR
